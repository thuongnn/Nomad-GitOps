...
# towards trying to get names like "active.vault.service.consul" to resolve _inside_ containers,
# you could try poaching nameserver IP addresses from VM/host /etc/resolv.conf and enter them here...
# recursors = [
#  "66.66.66.66",
# ]
